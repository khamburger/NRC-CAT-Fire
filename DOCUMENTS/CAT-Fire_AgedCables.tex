...
\textbf{Cables}
Two representative thermoplastic and thermoset cables were tested in this work. Both were 7-conductor, 12~AWG cables designed for...**. Representative images of each cable are provided in Fig.~\ref{}. Here, the cable cross section is shown along with an image of each cable when deconstructed into their constituent components (outer jacket, binder tape, inner insulation, wires). Cable supplier, manufacturer, and composition details are provided in Table~\ref{tab:cable_comparison}.
...
\begin{table}[h]
	...
	\begin{tabular}{rcc}
		...
		Outer Jacket & Chlorosulfonated Polyethylene & poly(vinyl chloride) \\ 
		Clear coating & - & Nylon \\ 
		Insulation & Fire Retardant Cross-linked Polyethylene & poly(vinyl chloride) \\ 
